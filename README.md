...
1. 点击直接下载预编译插件包：[📥 bug-lens-v0.2.0.zip](https://github.com/Aoyia/bug-lens/releases/download/v0.2.0/bug-lens-v0.2.0.zip)（或前往 [Releases 页面](https://github.com/Aoyia/bug-lens/releases/latest)）。
