...
const mockConsoleEntries: ConsoleEntry[] = [
  { id: "c1", createdAt: 1000, level: "log", text: "Application initialized", source: "app.js" },
  { id: "c2", createdAt: 2000, level: "warn", text: "Deprecated API called", source: "util.js" },
  { id: "c3", createdAt: 3000, level: "warning", text: "Memory threshold high", source: "system.js" },
  { id: "c4", createdAt: 4000, level: "error", text: "Failed to fetch user data", source: "api.js" },
  { id: "c5", createdAt: 5000, level: "debug", text: "State updated: { count: 1 }", source: "store.js" },
  { id: "c6", createdAt: 6000, level: "info", text: "User logged in", source: "auth.js" }
];
...
test("ConsoleTab - 7项搜索与筛选组合行为测试", () => {
  ...
  assert.deepEqual(searchRes.map((e) => e.id), ["c4", "c6"]);
  ...
  // 7. 无匹配情况
  const emptyRes = filterConsoleEntries(mockConsoleEntries, "error", "nonexistent-keyword");
