import type { EvidenceState, EvidenceSummary, NetworkEntry, RecordingSession } from "../shared/protocol.ts";
...
export function buildEvidenceSummary(session: RecordingSession, media: MediaSummary, networkEntries: NetworkEntry[]): EvidenceSummary[] {
